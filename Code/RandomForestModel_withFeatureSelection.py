...
# Model Evaluation
print(f"Score in Test Data : {rfc.score(X_test,y_test)}")
...
# Finding Random Forest accuracy and other measures
print("Random Forest with feature selection model accuracy(in %):", rfc.score(X_test, y_test)*100)
print('Mean Absolute Error:', metrics.mean_absolute_error(y_test, y_pred))
print('Mean Squared Error:', metrics.mean_squared_error(y_test, y_pred))
print('Root Mean Squared Error:', np.sqrt(metrics.mean_squared_error(y_test, y_pred)))

# Generating Classification Report for RandomForestClassifier
...
plt.title("Confusion Matrix for Random Forest with feature selection")
plt.show()
