...
# Model Evaluation
print(f"Score in Test Data : {ada.score(X_test,y_test)}")
...
print("Adaboost with feature selection accuracy(in %):", ada.score(X_test, y_test)*100)
...
plt.title("Confusion Matrix for Adaboost with feature selection")
plt.show()
