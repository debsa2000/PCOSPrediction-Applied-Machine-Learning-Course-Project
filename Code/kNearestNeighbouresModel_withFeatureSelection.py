...
# Model Evaluation
print(f"Score in Test Data : {knn.score(X_test,y_test)}")
...
# Finding kNN accuracy and other measures
print("k Nearest Neighbors with feature selection model accuracy(in %):", knn.score(X_test, y_test)*100)
...
plt.title("Confusion Matrix for kNN with feature selection")
plt.show()
